  ...
  $("#btn-create-group-chat").unbind("click").on("click", function(){
    ...
    Swal.fire({
      ...
      $.post("/group-chat/add-new", {
        ...
        if (subGroupChatName.length > 12) {
          subGroupChatName.subGroupChatName.substr(0,10); 
        } 
        let leftSideData = `
        ...
        let rightSideData = `
          <div class="right tab-pane " data-chat="${data.groupChat._id}" id="to_${data.groupChat._id}">  
            <div class="top">
                ...
                <span class="chat-menu-right">
                    <a href="javascripts:void(0)" class="number-members" data-toggle="modal">
                ...
                <span class="chat-menu-right">
                    <a href="javascripts:void(0)" class="number-messages" data-toggle="modal">
            ...
            <div class="write" data-chat="${data.groupChat._id}">
                ...
                <div class="icons">
                    ...
                    <a href="javascript:void(0)" id="video-chat-group" class="video-chat" data-chat="${data.groupChat._id}" data-toggle="modal">
        ...
        // Step 4: call function change screen chat
        changeScreenChat();
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Những hình ảnh của cuộc trò chuyện. </h4>
                    </div>
        ...
        // Step 8: emit new groupchat created
...
$(document).ready(function() {
  ...
  socket.on("response-new-group-created", function(response){
    // Step 01: hide modal: nothing to do
      ...
      <div class="right tab-pane " data-chat="${response.groupChat._id}" id="to_${response.groupChat._id}">  
        ...
        <div class="write" data-chat="${response.groupChat._id}">
            ...
            <div class="icons">
                ...
                <a href="javascript:void(0)" id="video-chat-group" class="video-chat" data-chat="${response.groupChat._id}" data-toggle="modal">
                    <i class="fa fa-video-camera"></i>
                </a>
            </div>
        </div>
    ...
    // Step 8: emit new groupchat created: nothing to do
